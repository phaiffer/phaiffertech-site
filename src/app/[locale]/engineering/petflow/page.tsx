...
export default async function PetflowPage({ params }: Props) {
  const { locale } = await params;
  const t = await getTranslations("privateCases.petflow");
